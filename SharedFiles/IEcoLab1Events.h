...
typedef struct IEcoLab1VTblEvents {
    ...
    /* IEcoLab1Events */
	int16_t (ECOCALLMETHOD *OnPrintType)(/* in */ struct IEcoLab1Events* me, /* in */ int16_t num);
	int16_t (ECOCALLMETHOD *OnPrintDataBefore)(/* in */ struct IEcoLab1Events* me, /* in */ double_t number, /* in */ double_t epsilon);
	int16_t (ECOCALLMETHOD *CurrentState)(/* in */ struct IEcoLab1Events* me, /* in */ int16_t index,double_t x,double_t epsilon);
	int16_t (ECOCALLMETHOD *OnPrintDataAfter)(/* in */ struct IEcoLab1Events* me, /* in */ double_t number) ;
